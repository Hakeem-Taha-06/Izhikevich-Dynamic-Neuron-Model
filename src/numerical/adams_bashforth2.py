...
def solve_adams_bashforth2(y0=None, t_span=None, dt=None, I_ext=None):
    ...
    Output:
    -------
    np.ndarray of shape (N, 3): [Time, v, w]
    """
    # Set defaults
    ...
    for i in range(1, num_steps):
        ...
        if reset_occurred:
            ...
            v_next, w_next = v_curr + delta_y[0], w_curr + delta_y[1]
            
            # Update history for next iteration
            F_prev = F_curr
            v_curr, w_curr = v_next, w_next
        ...
        if v_curr >= v_peak:
            ...
            results[i, 1] = v_peak
            results[i, 2] = w_curr # w continues to evolve normally until reset
